...
def iperf_job():
  ...
  bq_load_cmd = ['bq',
                 ...
                 'perfkit_mart.rt_iperf'] + result_file_path + SCHEMA_PATH
...
if __name__ == "__main__":
  ...
  for i in range(24):
    timestr = (datetime.datetime(2016,01,11,00,00,00)+datetime.timedelta(hours=i)).strftime("%H:%M")
    schedule.every().day.at(timestr).do(iperf_job)
